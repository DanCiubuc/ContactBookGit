...
public class Main {
    ...
    public static final String CONTACTS_WITH_EP = "There are contacts that share phone numbers.";
    public static final String CONTACTS_WITHOUT_EP = "All contacts have different phone numbers.";
    ...
    private static void equalPhoneNumbers(ContactBook cBook) {
        if (cBook.equalPhoneNumbers()) {
            System.out.println(CONTACTS_WITH_EP);
        }
        else {
            System.out.println(CONTACTS_WITHOUT_EP);
        }
    }
